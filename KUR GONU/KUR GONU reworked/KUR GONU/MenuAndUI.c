...
void game()
{
	...
	gotoXY( P1_SCREEN_X + 2, P1_SCREEN_Y + 2 ); setColorP1();			puts("RED	");
	gotoXY( P1_SCREEN_X + 2, P1_SCREEN_Y + 4 ); setColorDefault();		puts("Life"); 
	gotoXY( P1_SCREEN_X + 2, P1_SCREEN_Y + 5 ); setColorDefault();		puts("Kills");

	gotoXY( P1_SCREEN_X + 2, P2_SCREEN_Y + 2 ); setColorP2();			puts("BLUE	");
	gotoXY( P1_SCREEN_X + 2, P2_SCREEN_Y + 4 ); setColorDefault();		puts("Life"); 
	gotoXY( P1_SCREEN_X + 2, P2_SCREEN_Y + 5 ); setColorDefault();		puts("Kills");
...
void playerScreenUpdate(int player)
{
	...
	if( player == 1)
	{
		...
		// clear Life
		gotoXY( P1_LIFE_BOX_X, P1_LIFE_BOX_Y ); setColorBlank();
		for(i = 0; i < INPUT_BOX_LENGTH; i++){ 
			_putch(' '); 
		}
		// update Life
		gotoXY( P1_LIFE_BOX_X, P1_LIFE_BOX_Y ); setColorP1();
		for(i = 1; i <= lifeP1; i++ ){
			printf("♥");
		...
		// clear Kills
		gotoXY( P1_LIFE_BOX_X, P1_LIFE_BOX_Y+1 ); setColorBlank();
		for(i = 0; i < INPUT_BOX_LENGTH; i++){ 
			_putch(' '); 
		}
		// update Kills
		gotoXY( P1_LIFE_BOX_X, P1_LIFE_BOX_Y+1 ); setColorP2();
		for(i = 1; i <= kills; i++ ){
			printf("●");
		}
